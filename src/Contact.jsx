      ...
      <div className="max-w-7xl w-full space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="text-white space-y-6">
            ...
            <div>
              <p className="text-sm">Copyright &copy;2024 嗜茶小皇帝</p>
            </div>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-lg space-y-6">
            ...
            <div className="flex space-x-4">
              ...
              <div className="w-full">
                <label className="block text-sm font-medium text-gray-700">公司名称（如适用）</label>
                <input type="text" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" />
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700">兴趣领域</label>
              <select className="mt-1 block w-full px-3 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm">
                <option>请选择</option>
                <option>选项 1</option>
                <option>选项 2</option>
                <option>选项 3</option>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">您是如何得知我们的？</label>
              <select className="mt-1 block w-full px-3 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm">
                <option>请选择</option>
                <option>选项 1</option>
                <option>选项 2</option>
