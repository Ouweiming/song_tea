...
const Welcome = () => {
  return (
<div className="flex flex-col items-center justify-center w-full p-16 lg:p-48">
  <div className="text-center">
    <motion.h1
      className="text-3xl md:text-4xl lg:text-7xl font-bold text-emerald-400 bg-clip-text mb-12"
    ...
    <Heart className="my-6" /> {/* 假设 Heart 组件可以接受 className 作为 prop */}
...
const VideoBackground = () => {
  ...
  return (
    <>
      ...
      <div className="p-0 border-4 border-emerald-600 rounded-lg shadow-lg mr-20 ml-20 " style={{ boxSizing: 'border-box' }}>
  <div className="relative w-full overflow-hidden">
      {/* 增加内边距以增大空白 */}
      {/* 视频容器 */}
      <div className="relative h-0  pb-[56.25%] lg:pb-[40%]">
  <video
    src={video}
    autoPlay
    muted
...
<div className="absolute bottom-0 right-0 md:bottom-16 md:right-48 hidden md:flex items-center justify-center">
  <motion.button
    ...
    whileHover={{ scale: 1.05 }}
    whileTap={{ scale: 0.95 }}
    className="flex items-center text-2xl px-6 py-3 bg-transparent hover:bg-emerald-600 text-white border border-white dark:border-white font-semibold rounded-full shadow-lg"
  >
